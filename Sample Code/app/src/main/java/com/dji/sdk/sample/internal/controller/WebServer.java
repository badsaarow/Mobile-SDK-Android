...
public class WebServer extends NanoHTTPD {
    ...
    public Response serve(IHTTPSession session) {
        ...
        if (session.getUri().startsWith("/cmd")) {
            ...
            sb.append("<button id=\"lleft\" onkeydown=\"joystick.lpx=-5;startMove()\" onkeyup=\"stopMove()\">LEFT</button>");
            sb.append("<button id=\"lright\" onkeydown=\"joystick.lpx=5;startMove()\" onkeyup=\"stopMove()\">RIGHT</button>");
            sb.append("<button id=\"lup\" onkeydown=\"joystick.lpy=5;startMove()\" onkeyup=\"stopMove()\">UP</button>");
            sb.append("<button id=\"ldown\" onkeydown=\"joystick.lpy=-5;startMove()\" onkeyup=\"stopMove()\">DOWN</button>");
            sb.append("</div>");
            sb.append("<div class=\"right\">");
            sb.append("<button id=\"rleft\" onkeydown=\"joystick.rpx=-5;startMove()\" onkeyup=\"stopMove()\">LEFT</button>");
            sb.append("<button id=\"rright\" onkeydown=\"joystick.rpx=5;startMove()\" onkeyup=\"stopMove()\">RIGHT</button>");
            sb.append("<button id=\"rup\" onkeydown=\"joystick.rpy=5;startMove()\" onkeyup=\"stopMove()\">UP</button>");
            sb.append("<button id=\"rdown\" onkeydown=\"joystick.rpy=-5;startMove()\" onkeyup=\"stopMove()\">DOWN</button>");
            sb.append("</div>");
            sb.append("</div>");
